...
export const config = {
  ...
  // ── Memory Gallery ─────────────────────────────────────────
  gallery: [
    { src: "/photos/pic1.jpg", caption: "Us 💛",                          type: "image", zoom: true },
    { src: "/photos/pic2.jpg", caption: "From the very beginning 🌸",     type: "image" },
    { src: "/photos/pic3.jpg", caption: "Love is us ❤️",                  type: "image" },
    { src: "/photos/pic5.jpg", caption: "Golden hour with you ✨",        type: "image", zoom: true },
...
Happy Birthday, kuchupuchuu.`,
  ...
  songs: [
    {
      title:    "Him & I",
      occasion: "The song that found me right when you did ✨",
      src:      "/audio/song1.mp3",
      albumArt: null,
      lyrics:   null,
    },
